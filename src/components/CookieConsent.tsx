        ...
        >
          <div className="max-w-4xl mx-auto bg-brand-900/95 backdrop-blur-xl border border-white/10 rounded-2xl px-5 py-4 sm:px-6 sm:py-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                onClick={necessary}
                className="px-5 py-3 text-xs font-medium text-white/70 border border-white/20 rounded-lg hover:bg-white/5 transition-colors whitespace-nowrap"
              >
                {t.privacy.cookieNecessary}
              </button>
              <button
                onClick={accept}
                className="px-5 py-3 text-xs font-semibold text-white bg-accent-700 rounded-lg hover:bg-accent-600 transition-colors whitespace-nowrap"
              >
