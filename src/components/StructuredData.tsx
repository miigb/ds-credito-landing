...
const financialServiceSchema = {
  ...
  identifier: {
    "@type": "PropertyValue",
    name: "Banco de Portugal Registration",
    value: siteConfig.regulation.registrationNumber,
    url: siteConfig.regulation.registryUrl,
  },
  address: {
    "@type": "PostalAddress",
