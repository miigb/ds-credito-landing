  ...
  return (
    <footer className="relative overflow-hidden bg-hero-gradient">
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-20 lg:pt-28 pb-10">
          ...
          >
            {links.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="text-sm font-medium tracking-wide text-white/60 hover:text-accent-400 transition-colors duration-300"
              >
                {link.label}
              </a>
            ))}
        ...
        {/* ── Socials + ANICA membership ── */}
        <FadeIn delay={0.2} className="mt-12">
          <div className="flex flex-col items-center gap-8">
            <div className="flex items-center gap-6">
              <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/40 hover:text-accent-400 transition-colors duration-300">
              ...
              <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/40 hover:text-accent-400 transition-colors duration-300">
              ...
              <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-white/40 hover:text-accent-400 transition-colors duration-300">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300"
            >
              <img
                src="/anica-logo.png"
                alt="ANICA"
        ...
        {/* ── End bar: legal links + copyright ── */}
        <div className="mt-8 border-t border-white/10 pt-6 flex flex-col items-center gap-4">
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs">
            <a
              href="/privacidade"
              className="text-white/45 hover:text-accent-400 underline underline-offset-2 transition-colors"
            >
