      ...
      {visible && (
        ...
        >
          <div className="max-w-7xl mx-auto px-4 lg:px-8 h-14 lg:h-12 flex items-center justify-between gap-3">
            ...
            <button
              onClick={handleClick}
              className="px-5 py-2 lg:py-1.5 text-sm font-semibold rounded-lg bg-accent-700 text-white hover:bg-accent-600 transition-all duration-200 shadow-md shadow-accent-700/20 whitespace-nowrap shrink-0"
            >
              {barContent.cta}
            </button>
          </div>
