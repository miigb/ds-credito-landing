  ...
  return (
    ...
    >
      <Link
        ...
        className={`block h-full bg-white/5 border border-white/10 rounded-xl p-8 transition-all duration-300 group cursor-pointer ${
          isTBD ? "opacity-50 pointer-events-none" : "hover:bg-white/10"
        }`}
      >
