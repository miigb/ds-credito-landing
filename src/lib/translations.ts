...
export const translations = {
  ...
  pt: {
    ...
    hero: {
      eyebrow: "DS Crédito Setúbal Vitória",
      headlineStart: "O parceiro de crédito que ",
      headlineHighlight: "fecha mais negócios consigo",
      subheading:
        "Somos intermediários de crédito independentes ao serviço de imobiliárias, mediadores e promotores. Tratamos de todo o financiamento dos seus clientes — da pré-análise à escritura — para que se foque no que melhor sabe fazer: vender.",
      ctaPrimary: "Agendar Reunião",
      ctaSecondary: "Como Funciona",
      badgeIndependent: "Intermediário Independente",
      badgeInternational: "Parceiros Locais & Internacionais",
