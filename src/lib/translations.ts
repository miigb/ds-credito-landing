...
export const translations = {
  ...
  pt: {
    ...
    profile: {
      ...
      scanQR: "Digitalize para guardar o contacto",
      backToTeam: "Voltar à equipa",
      about: "Sobre",
      contactAgent: "Contacto",
      specializations: "Especialidades",
      languages: "Idiomas",
      availableNow: "Disponível agora",
      unavailable: "Fora do horário",
      officeHours: "Seg-Sex 9h-18h",
      copied: "Copiado!",
    },
    // Success Stories
    success: {
