...
export const translations = {
  ...
  pt: {
    ...
    preQualification: {
      ...
      failTitle: "Pode haver limitações.",
      failDesc: "Com base nas suas respostas, poderá haver dificuldades na aprovação do crédito. Mas não desista — cada caso é único.",
      failDetail: "A nossa equipa pode analisar a sua situação em detalhe e encontrar alternativas. Sem qualquer custo para si.",
      failCta: "Contactar Especialista",
